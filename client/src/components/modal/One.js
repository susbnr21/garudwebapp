...
import Spray from '../../assets/fighting.jpg'
...
class One extends Component{
    constructor() {
        ...
        this.state = {
            name: "",
            room_size: "1000 SQFT. OFFICE ROOM",
            emailing_address: "",
            phone_number: "",
            company_name: "",
            company_address: "",
    ...
    render() {
        ...
        return(
            <div style={{display: 'inline', marginRight: 40}}>
               <button className="btn modal-trigger" href="#modal1" style={{height:'100px', width: '200px'}}>
                ...
                <form id="modal1" className="modal" noValidate onSubmit={this.handleSubmit}>
                    ...
                    <h5 style={{textDecoration: 'underline', fontWeight: 'bold'}}>You Have Selected 1000 Sqft Office Room </h5>
                        <div className="row">
                        ...
                        <div className="disabled-input-field col s6">
                            ...
                            <input disabled value="1000 SQFT. OFFICE ROOM" id="disabled" type="text" className="validate"/>
                        </div>
