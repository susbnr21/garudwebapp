...
import Spray from '../../assets/spray4.jpg'
...
class Four extends Component{
    constructor() {
        ...
        this.state = {
            name: "",
            room_size: "4000 SQFT. OFFICE ROOM",
            emailing_address: "",
            phone_number: "",
            company_name: "",
            company_address: "",
    ...
    render() {
        ...
        return(
            <div style={{display: 'inline', marginRight: 40}}>
               <button className="btn modal-trigger" href="#modal4" style={{height:'100px', width: '200px'}}>
                    <img src={Spray} style={{height:'100px', width: '200px'}} className='hoverable'/>
                </button> 
                <form id="modal4" className="modal" noValidate onSubmit={this.handleSubmit}>
                    <div className="modal-content" style={{height: 450}}>
                    <h5 style={{textDecoration: 'underline', fontWeight: 'bold'}}>You Have Selected 4000 Sqft Office Room </h5>
                        <div className="row">
