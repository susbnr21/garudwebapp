...
import Spray from '../../assets/spray3.jpg'
...
class Five extends Component{
    constructor() {
        ...
        this.state = {
            name: "",
            room_size: "5000 SQFT. OFFICE ROOM",
            emailing_address: "",
            phone_number: "",
            company_name: "",
            company_address: "",
    ...
    render() {
        ...
        return(
            <div style={{display: 'inline', marginRight: 40}}>
               <button className="btn modal-trigger" href="#modal5" style={{height:'100px', width: '200px'}}>
                    <img src={Spray} style={{height:'100px', width: '200px'}} className='hoverable'/>
                </button> 
                <form id="modal5" className="modal" noValidate onSubmit={this.handleSubmit}>
                    <div className="modal-content" style={{height: 450}}>
                    <h5 style={{textDecoration: 'underline', fontWeight: 'bold'}}>You Have Selected 5000 Sqft Office Room </h5>
                        <div className="row">
                        ...
                        <div className="disabled-input-field col s6">
                            ...
                            <input disabled value="5000 SQFT. OFFICE ROOM" id="disabled" type="text" className="validate"/>
                        </div>
